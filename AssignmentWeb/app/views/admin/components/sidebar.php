<script src="<?php echo URL::to('app/views/admin/assets/static/js/initTheme.js'); ?>"></script>
    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="<?= URL::to('public/admin/index') ?>">
                        <img src="<?= URL::to('app/views/admin/assets/compiled/svg/logo.svg') ?>" alt="Logo" />
                    </a>
                </div>
            ...
            <ul class="menu">
                ...
                <li
                    ...
                    <ul
                        ...
                        <li class="submenu-item <?php echo isMenuActive('/admin/security') ? 'active' : ''; ?>">
                            <a href="<?php echo URL::to('public/admin/security'); ?>" class="submenu-link">Security</a>
                        </li>
                    </ul>
                </li>
